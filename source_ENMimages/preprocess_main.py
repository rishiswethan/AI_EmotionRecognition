...
######################################################################
data_train_path = MAIN_PATH + "data_ENMimages\\"
...
def create_data():
    try:
        ...
        for i in range(35800):
            ...
            faces, face_landmarks, foundface = crop_face.getFacialLandmarks(image_dir=MAIN_PATH + "faces/" + str(i) + '.png',
                                                                                 showImg=False)
            # print("f", foundface)
            if foundface:
